    ...
    <View style={[styles.container, { backgroundColor: theme.background }]}>
      ...
      <ScrollView style={styles.content} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.section}>
          ...
          <View style={[styles.settingItem, { borderBottomColor: theme.border }]}>
            ...
            <Switch
              ...
              trackColor={{ false: "#767577", true: theme.primary + "80" }}
              thumbColor={emailNotificationsEnabled ? theme.primary : "#f4f3f4"}
            />
          </View>
        </View>

        <View style={styles.section}>
          <Text style={[styles.sectionTitle, { color: theme.text }]}>Client Settings</Text>

          <View style={[styles.settingItem, { borderBottomColor: theme.border }]}>
            <View style={styles.settingInfo}>
              <Ionicons name="briefcase-outline" size={22} color={theme.primary} />
              <Text style={[styles.settingText, { color: theme.text }]}>Project Updates</Text>
            </View>
            <Switch
              value={projectUpdatesEnabled}
              onValueChange={setProjectUpdatesEnabled}
              trackColor={{ false: "#767577", true: theme.primary + "80" }}
              thumbColor={projectUpdatesEnabled ? theme.primary : "#f4f3f4"}
            />
          </View>
          ...
          <View style={[styles.settingItem, { borderBottomColor: theme.border }]}>
            ...
            <Switch
              ...
              trackColor={{ false: "#767577", true: theme.primary + "80" }}
              thumbColor={profileVisibility ? theme.primary : "#f4f3f4"}
            />
          </View>
          ...
          <TouchableOpacity style={[styles.settingItem, { borderBottomColor: theme.border }]}>
            <View style={styles.settingInfo}>
              ...
              <Text style={[styles.settingText, { color: theme.text }]}>Billing History</Text>
            </View>
            <Ionicons name="chevron-forward" size={20} color={theme.text + "80"} />
          </TouchableOpacity>
        </View>
        ...
        <View style={styles.actionButtons}>
          <TouchableOpacity style={[styles.signOutButton, { borderColor: theme.primary }]} onPress={signOut}>
...
export default withAuth(ClientSettingsScreen)
