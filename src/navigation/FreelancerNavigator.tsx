...
import { DashboardFreelancerProvider } from "../contexts/Freelancer/DashboardContext";
...
const FreelancerNavigator = () => {
  return (
    <Stack.Navigator screenOptions={{ headerShown: false }}>
      ...
      <Stack.Screen
        name="FreelancerSettings"
        component={FreelancerSettingsScreen}
      />
    </Stack.Navigator>
  );
};
